...
cp native/build-x86/src/Release/Luna.exe build/win-x86/
cp build/libs/Luna.jar build/win-x86/
...
echo Luna.exe 32bit sha256sum
sha256sum build/win-x86/Luna.exe

dumpbin //HEADERS build/win-x86/Luna.exe
