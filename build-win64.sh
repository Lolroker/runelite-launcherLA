...
cp native/build-x64/src/Release/Luna.exe build/win-x64/
cp build/libs/Luna.jar build/win-x64/
...
echo Luna.exe 64bit sha256sum
sha256sum build/win-x64/Luna.exe

dumpbin //HEADERS build/win-x64/Luna.exe
