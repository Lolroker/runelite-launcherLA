...
chmod 644 build/libs/Luna.jar

cp native/build-aarch64/src/Luna build/linux-aarch64/
cp build/libs/Luna.jar build/linux-aarch64/
...
# Ensure Luna is executable to all users
chmod 755 Luna
popd
