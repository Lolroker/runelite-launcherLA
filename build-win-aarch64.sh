...
cp native/build-aarch64/src/Release/Luna.exe build/win-aarch64/
cp build/libs/Luna.jar build/win-aarch64/
...
echo Luna.exe aarch64 sha256sum
sha256sum build/win-aarch64/Luna.exe

dumpbin //HEADERS build/win-aarch64/Luna.exe
